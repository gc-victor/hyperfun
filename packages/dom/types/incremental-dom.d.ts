declare module 'incremental-dom' {
    ...
    export declare var notifications: {
        nodesCreated: (nodes: Array<HyperScriptNode>) => void;
        nodesDeleted: (nodes: Array<HyperScriptNode>) => void;
    };
}
